...
export class CreateInitialSchema1700000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS "ui_component_example" CASCADE`);
    await queryRunner.query(`DROP TABLE IF EXISTS "ui_component" CASCADE`);
    await queryRunner.query(`DROP TABLE IF EXISTS "ui_registry" CASCADE`);
  }
}
